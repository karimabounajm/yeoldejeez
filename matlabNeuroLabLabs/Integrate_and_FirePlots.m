...
%Defining Initial Values and Vector Data Structures:
...
% Note, it iterates from t = 1.43ms to 1.63ms in intervals of 0.02ms.


for I_Stim = I_Stim_vect; %primary for-loop iterating over time periods, and allowing for multiple
	% plots to be drawn comparing 
	PlotNum = PlotNum + 1;
